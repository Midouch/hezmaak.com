...
async function contactUser(userId, tripId = null, requestId = null) {
  ...
  try {
    ...
    /*
     * Ordiniamo sempre i partecipanti nello stesso modo.
     * Questo evita di creare due conversazioni diverse
    ...
    if (searchError) {
      ...
      console.error(
        "Errore ricerca conversazione:",
        searchError
      );

      alert(
        "Errore apertura chat: " +
        searchError.message
      );
